        ...
        >
          ...
          >
             ...
             <div className="flex-1 relative flex items-center justify-center overflow-hidden cursor-crosshair">
                ...
                {/* Second Paragraph - Fade in on hover */}
                <motion.div 
                  ...
                  className="absolute inset-0 z-30 p-8 md:p-20 flex flex-col justify-center items-center text-center bg-background/60"
                >
                  <p className="text-sm md:text-lg text-foreground leading-relaxed italic font-medium max-w-md">
