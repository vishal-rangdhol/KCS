    ...
    <main className="relative min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary selection:text-white">
      ...
      <div className="relative z-10 pt-24 md:pt-32 pb-20 px-4 md:px-12 lg:px-20 max-w-7xl mx-auto">
        ...
        <section className="mb-12 md:mb-20 text-center">
          ...
          >
            <span className="flex items-center justify-center gap-2 text-primary font-bold tracking-[0.4em] md:tracking-[0.5em] uppercase text-[9px] sm:text-[10px] mb-6 md:mb-8 font-headline">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 w-full max-w-5xl text-left mb-16 px-2">
              <div className="p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] bg-white/5 border border-white/5 group hover:border-primary/20 transition-all duration-500 shadow-sm">
              ...
              <div className="p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] bg-white/5 border border-white/5 group hover:border-secondary/20 transition-all duration-500 shadow-sm">
                ...
                <Button 
                  className="w-full h-12 rounded-xl bg-primary hover:bg-primary/90 text-white font-bold text-sm md:text-base group shadow-xl border-none transition-all duration-300"
                  asChild
                >
